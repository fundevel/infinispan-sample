 ...
 * @author seoi
 */
public class LocalOrderedMailBoxListTest {

    private static final Logger logger = LogManager.getLogger(LocalOrderedMailBoxListTest.class);
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        //Log4j 설정
        String logConfigurationFile = LocalOrderedMailBoxListTest.class.getClassLoader().getResource("log4j2.xml").getPath();
